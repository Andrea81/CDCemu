/*
  ...
  Edited by Andrea Colma to work with Blaupunkt DMS cd changers
*/
...
void SoftwareSerial::print(uint8_t b)
{
  ...
  digitalWrite(_transmitPin, LOW); //modded was HIGH but Blaupunkt protocol has a LOW idle state
  delayMicroseconds(bitDelay);
